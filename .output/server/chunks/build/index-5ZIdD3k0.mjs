...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ProductRetailIndonesiaCraft.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_ProductRetailIndonesiaCraft = __nuxt_component_4;
  ...
  _push(ssrRenderComponent(_component_BreadcrumbOne, {
    activePageName: "Indonesia Craft",
    title: "Indonesia Craft",
    backgroundUrl: "/images/bg/breadcrumb-bg-darkgray.png"
  }, null, _parent));
  _push(ssrRenderComponent(_component_ProductRetailIndonesiaCraft, null, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/products/indonesia-craft/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { index as default };
//# sourceMappingURL=index-5ZIdD3k0.mjs.map
