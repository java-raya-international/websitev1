...
const _imports_0 = publicAssetsURL("/images/project/work-details-1.jpg");
const _imports_1 = publicAssetsURL("/images/project/work-details-2.jpg");
const _imports_2 = publicAssetsURL("/images/project/work-details-3.jpg");
const _imports_3 = publicAssetsURL("/images/project/work-details-4.jpg");
const _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_BreadcrumbOne, {
    activePageName: "Project Details",
    title: "We work with bold brands that we believe in",
    backgroundUrl: "/images/bg/breadcrumb-bg-two.jpg"
  }, null, _parent));
  _push(`<div class="section-padding"><div class="container"><div class="row"><div class="col-lg-4 col-md-6 col-12"><div class="work-left work-details" data-aos="fade-up"><div class="portfolio-main-info"><h2 class="title">About the <br> project</h2><div class="work-details-list mt-40"><div class="details-list"><label>Date</label><span>28 Sep 2007</span></div><div class="details-list"><label>Client</label><span>HighGrove Partners</span></div><div class="details-list"><label>Categories</label><span>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/project/project-details.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const projectDetails = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { projectDetails as default };
//# sourceMappingURL=project-details-CT5osgwe.mjs.map
