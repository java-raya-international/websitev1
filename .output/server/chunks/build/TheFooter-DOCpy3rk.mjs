...
const _imports_0$1 = publicAssetsURL("/images/logo/javaraya-logo-black-bg-transparent.png");
const _sfc_main$4 = {
  components: {
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img class="dark-logo"${ssrRenderAttr("src", _imports_0$1)} alt="Javaraya Logo"${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
            class: "dark-logo",
  ...
  _push(`</div><div class="header-search-area"></div><div class="header-mobile-menu-toggle d-xl-none ml-sm-2"><button class="toggle"><i class="icon-top"></i><i class="icon-middle"></i><i class="icon-bottom"></i></button></div></div></div></div></div></div>`);
}
...
const footerAboutWidget = {
  logoSrc: "/images/logo/javaraya-logo-black-bg-transparent.png",
...
//# sourceMappingURL=TheFooter-DOCpy3rk.mjs.map
