...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.BwnSUlTM.mjs').then(interopDefault),
  ...
  "components/PortfolioGalleryTwo.vue": () => import('./PortfolioGalleryTwo-styles.CHgc_P-7.mjs').then(interopDefault),
  "components/ProductMaterialCarbonActivated.vue": () => import('./ProductMaterialCarbonActivated-styles.KgVGKGto.mjs').then(interopDefault),
