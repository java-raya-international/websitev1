...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img style="${ssrRenderStyle({ "opacity": "0.5" })}" class="dark-logo"${ssrRenderAttr("src", _imports_0)} alt="Javaraya Logo"${_scopeId}><img style="${ssrRenderStyle({ "opacity": "0.5" })}" class="light-logo"${ssrRenderAttr("src", _imports_0)} alt="Javaraya Logo"${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
            style: { "opacity": "0.5" },
...
//# sourceMappingURL=TheFooter-CTCOFuNx.mjs.map
