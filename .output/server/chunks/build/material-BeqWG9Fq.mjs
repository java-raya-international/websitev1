...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_BreadcrumbOne, {
    activePageName: "Material",
    title: "Material Business",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/business/material.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const material = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { material as default };
//# sourceMappingURL=material-BeqWG9Fq.mjs.map
