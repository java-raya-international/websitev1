...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file://E:/Projects/JavaRayaInternational/website/node_modules/ufo/dist/index.mjs';
...
import { consola } from 'file://E:/Projects/JavaRayaInternational/website/node_modules/consola/dist/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"E:\\Projects\\JavaRayaInternational\\website\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _hdi0OtbOJu = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "E:/Projects/JavaRayaInternational/website";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _yyj18dAgzi = (nitroApp) => {
...
const _lazy_wIhlfx = () => Promise.resolve().then(function () { return renderer$1; });
...
const getClientManifest = () => import('file://E:/Projects/JavaRayaInternational/website/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://E:/Projects/JavaRayaInternational/website/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
