...
import { useSSRContext, mergeProps, withCtx, createVNode, createTextVNode, toDisplayString } from 'file://E:/Projects/JavaRayaInternational/website/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderStyle, ssrRenderAttr, ssrInterpolate, ssrRenderList } from 'file://E:/Projects/JavaRayaInternational/website/node_modules/vue/server-renderer/index.mjs';
...
const featureData = [
  {
    ...
    slug: "ai",
    text: "LLM and SLM optimize for local and cross-border marketplace. ",
  ...
  },
  {
    ...
    title: "Blockchain",
    slug: "blockchain",
    text: "Transparent data can be leveraged by utilizing Level 1 and Level 2 blockchain technology.",
    iconSrc: "/images/svg/frontpage/frontpage-blockchain.svg",
  ...
  },
  {
    ...
    slug: "decentralized",
    text: "Seriously handle privacy for our customers",
    iconSrc: "/images/svg/frontpage/frontpage-decentralized.svg",
    imgSrc: "/images/project/work-details-3.jpg"
  },
  {
    id: 4,
    title: "Run on any devices",
    slug: "multidevice",
    text: "Run on Web, Mobile, TV, and VR",
  ...
  },
  {
    ...
    slug: "product",
    text: "Marketplace focus with selected product ",
  ...
  },
  {
    ...
    title: "SME Business",
    slug: "msmb",
    text: "Helping micro, small and medium business to grow together",
    iconSrc: "/images/svg/frontpage/frontpage-sme.svg",
    imgSrc: "/images/project/work-details-2.jpg"
  }
];
const _sfc_main$5 = {
...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  ssrRenderList($data.featureData.slice(0, 6), (feature, index) => {
    ...
    _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`${ssrInterpolate(feature.title)}`);
        } else {
          return [
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  ssrRenderList($data.featureData.slice(0, 6), (feature, index) => {
    ...
    _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`\${feature.title}`);
        } else {
          return [
            createTextVNode("${feature.title}")
          ];
        }
      }),
      _: 2
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--]--></ul></div></div></div></div><div class="row"><div class="col"><p class="copyright">\xA9 2024 Java Raya International LTD.</p></div></div></div></div>`);
}
...
export { __nuxt_component_0 as _, __nuxt_component_1 as a, __nuxt_component_2 as b, __nuxt_component_8 as c, featureData as f };
//# sourceMappingURL=TheFooter-D3TO_vSB.mjs.map
