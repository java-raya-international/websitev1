...
import { ssrRenderStyle, ssrRenderAttrs, ssrRenderAttr, ssrRenderComponent } from "vue/server-renderer";
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  _push(`<!--[--><div class="main-container"><div><h1>We will use and develop our own marketplace</h1><p>We will develop e-commerce for our selling products in the web application and mobile application</p><p>Our priorrity is B2B customer with bulk buyer.</p><p>Below is our plan for app development until 2025 (2 year action plan)</p><p>We will split the stores from B2B customers and B2C customers</p></div><div class="intro-section overlay bg-cover" style="${ssrRenderStyle({
...
//# sourceMappingURL=company-Bx80tCJ1.js.map
