...
export default {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.BwnSUlTM.mjs').then(interopDefault),
  "components/PortfolioGalleryTwo.vue": () => import('./_nuxt/PortfolioGalleryTwo-styles.CHgc_P-7.mjs').then(interopDefault),
  "components/ProductMaterialCarbonActivated.vue": () => import('./_nuxt/ProductMaterialCarbonActivated-styles.KgVGKGto.mjs').then(interopDefault),
